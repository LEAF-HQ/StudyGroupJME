...
analysisname     = 'StudyGroup'
user             = 'anmalara'
input_base_path  = '/user/anmalara/WorkingArea/CMSSW_10_6_28/src/LEAF/../../..'
result_base_path = '/user/anmalara/WorkingArea/CMSSW_10_6_28/src/LEAF/../../..'
